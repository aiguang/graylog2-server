...
public class Searches {
    ...
    private final static String AGG_TERMS = "gl2_terms";
    private final static String AGG_STATS = "gl2_stats";
    private final static String AGG_TERMS_STATS = "gl2_termsstats";
    private static final String AGG_FILTER = "gl2_filter";
    private static final String AGG_HISTOGRAM = "gl2_histogram";
        ...
        FilterAggregationBuilder builder = AggregationBuilders.filter(AGG_FILTER)
                .subAggregation(
                        AggregationBuilders.dateHistogram(AGG_HISTOGRAM)
                                .field("timestamp")
                                .interval(new DateHistogram.Interval(interval.toString().toLowerCase())))
                .filter(standardFilters(range, filter));
